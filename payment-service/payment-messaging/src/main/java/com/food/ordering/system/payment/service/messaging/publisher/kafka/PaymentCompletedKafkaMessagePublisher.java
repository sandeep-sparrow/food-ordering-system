...
public class PaymentCompletedKafkaMessagePublisher implements PaymentCompletedMessagePublisher {
    ...
    private final PaymentServiceConfigData paymentServiceDataConfigData;
    ...
    public void publish(PaymentCompletedEvent domainEvent) {
        ...
        try {
            ...
            kafkaProducer.send(paymentServiceDataConfigData.getPaymentResponseTopicName(),
                    orderId,
                    paymentResponseAvroModel,
                    kafkaMessageHelper
                            .getKafkaCallback(paymentServiceDataConfigData.getPaymentResponseTopicName(),
                                    paymentResponseAvroModel,
                                    orderId,
                                    "PaymentResponseAvroModel"));

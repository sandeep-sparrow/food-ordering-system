...
public class RestaurantApprovalResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -9199100719307333575L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"RestaurantApprovalResponseAvroModel\",\"namespace\":\"com.food.ordering.system.kafka.order.avro.model\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"sagaId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"restaurantId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"orderId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"createdAt\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}},{\"name\":\"orderApprovedStatus\",\"type\":{\"type\":\"enum\",\"name\":\"OrderApprovedStatus\",\"symbols\":[\"APPROVED\",\"REJECTED\"]}},{\"name\":\"failureMessages\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}}]}");
  ...
  private com.food.ordering.system.kafka.order.avro.model.OrderApprovedStatus orderApprovedStatus;
   ...
   * @param orderApprovedStatus The new value for orderApprovedStatus
   * @param failureMessages The new value for failureMessages
   */
  public RestaurantApprovalResponseAvroModel(java.lang.String id, java.lang.String sagaId, java.lang.String restaurantId, java.lang.String orderId, java.time.Instant createdAt, com.food.ordering.system.kafka.order.avro.model.OrderApprovedStatus orderApprovedStatus, java.util.List<java.lang.String> failureMessages) {
    this.id = id;
    this.sagaId = sagaId;
    this.restaurantId = restaurantId;
    this.orderId = orderId;
    this.createdAt = createdAt.truncatedTo(java.time.temporal.ChronoUnit.MILLIS);
    this.orderApprovedStatus = orderApprovedStatus;
  ...
  public java.lang.Object get(int field$) {
    ...
    case 5: return orderApprovedStatus;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 5: orderApprovedStatus = (com.food.ordering.system.kafka.order.avro.model.OrderApprovedStatus)value$; break;
  ...
  /**
   * Gets the value of the 'orderApprovedStatus' field.
   * @return The value of the 'orderApprovedStatus' field.
   */
  public com.food.ordering.system.kafka.order.avro.model.OrderApprovedStatus getOrderApprovedStatus() {
    return orderApprovedStatus;
  }


  /**
   * Sets the value of the 'orderApprovedStatus' field.
   * @param value the value to set.
   */
  public void setOrderApprovedStatus(com.food.ordering.system.kafka.order.avro.model.OrderApprovedStatus value) {
    this.orderApprovedStatus = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RestaurantApprovalResponseAvroModel>
    ...
    private Builder(com.food.ordering.system.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder other) {
      ...
      if (isValidValue(fields()[5], other.orderApprovedStatus)) {
        this.orderApprovedStatus = data().deepCopy(fields()[5].schema(), other.orderApprovedStatus);
    ...
    /**
      * Sets the value of the 'orderApprovedStatus' field.
      * @param value The value of 'orderApprovedStatus'.
      * @return This builder.
      */
    public com.food.ordering.system.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder setOrderApprovedStatus(com.food.ordering.system.kafka.order.avro.model.OrderApprovedStatus value) {
    ...
    /**
      * Checks whether the 'orderApprovedStatus' field has been set.
      * @return True if the 'orderApprovedStatus' field has been set, false otherwise.
      */
    public boolean hasOrderApprovedStatus() {
      return fieldSetFlags()[5];
    }


    /**
      * Clears the value of the 'orderApprovedStatus' field.
      * @return This builder.
      */
    public com.food.ordering.system.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder clearOrderApprovedStatus() {
      orderApprovedStatus = null;
    ...
    public RestaurantApprovalResponseAvroModel build() {
      try {
        ...
        record.orderApprovedStatus = fieldSetFlags()[5] ? this.orderApprovedStatus : (com.food.ordering.system.kafka.order.avro.model.OrderApprovedStatus) defaultValue(fields()[5]);
